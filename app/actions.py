...
def build_operator_summary(severity: str, incident_type: str, risk_drivers: list[str]) -> str:
    ...
    confirmed_clear_radius = "GISTDA checked, no hotspot detected in monitored radius" in risk_drivers
    if severity == 'LOW' and confirmed_clear_radius:
        return f"No hotspot was detected in the monitored radius for this {label} area. Continue routine monitoring."
